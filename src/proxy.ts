...
const publicPrefixes = ['/giris', '/davet/', '/r/', '/u/', '/gizlilik', '/api/track', '/api/unsubscribe', '/api/webhooks', '/api/cron', '/api/health', '/api/brand/', '/opengraph-image', '/brand/', '/fonts/', '/bg/', '/film/']
